...
extends AbstractParser {
    ...
    public String getChunk(SyntaxChunk[] chunks, SyntaxChunk thisChunk, String[] values, String chunkValue) {
        ...
        for (Setting v : m.settingList) {
            if (!(v instanceof Named) || !((Named)((Object)v)).getName().toLowerCase().startsWith(chunkValue.toLowerCase())) continue;
            possibilities.put(((Named)((Object)v)).getName(), v);
        }
        ...
        return ((Named)((Object)aV)).getName().substring(chunkValue.length());
    }
}
