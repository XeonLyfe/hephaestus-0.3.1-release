...
public class ColourUtils {
    ...
    public static int toRGBA(double r, double g, double b, double a) {
        return ColourUtils.toRGBA((float)r, (float)g, (float)b, (float)a);
    }
    ...
    public static int toRGBA(float r, float g, float b, float a) {
        return ColourUtils.toRGBA((int)(r * 255.0f), (int)(g * 255.0f), (int)(b * 255.0f), (int)(a * 255.0f));
    }
    ...
    public static int toRGBA(float[] colors) {
        ...
        return ColourUtils.toRGBA(colors[0], colors[1], colors[2], colors[3]);
    }
    ...
    public static int toRGBA(double[] colors) {
        ...
        return ColourUtils.toRGBA((float)colors[0], (float)colors[1], (float)colors[2], (float)colors[3]);
    }
