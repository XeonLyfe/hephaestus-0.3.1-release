...
@Mod(modid="hephaestus", name="Hephaestus", version="0.3.1")
public class KamiMod {
    ...
    public static final Logger log = LogManager.getLogger((String)"Hephaestus");
    ...
    public static String getConfigName() {
        Path config = Paths.get("Hephaestus_LastConfig.txt", new String[0]);
    ...
    public void init(FMLInitializationEvent event) {
        ...
        log.info("Hephaestus initialized!\n");
    }
