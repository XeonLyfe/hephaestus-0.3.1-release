...
public class Module {
    ...
    private Info getAnnotation() {
        return this.getClass().isAnnotationPresent(Info.class) ? this.getClass().getAnnotation(Info.class) : Sprint.class.getAnnotation(Info.class);
    }
    ...
    extends Converter<Bind, JsonElement> {
        ...
        protected Bind doBackward(JsonElement jsonElement) {
            ...
            int key = -1;
            try {
                key = Keyboard.getKeyIndex((String)s);
            }
