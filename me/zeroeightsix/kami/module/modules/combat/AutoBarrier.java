...
@Module.Info(name="AutoBarrier", category=Module.Category.COMBAT)
public class AutoBarrier
extends Module {
    ...
    protected void onEnable() {
        AutoBarrier.mc.player.connection.sendPacket((Packet)new CPacketEntityAction((Entity)AutoBarrier.mc.player, CPacketEntityAction.Action.START_SNEAKING));
        this.oldSlot = Wrapper.getPlayer().inventory.currentItem;
    }

    @Override
    protected void onDisable() {
        AutoBarrier.mc.player.connection.sendPacket((Packet)new CPacketEntityAction((Entity)AutoBarrier.mc.player, CPacketEntityAction.Action.STOP_SNEAKING));
